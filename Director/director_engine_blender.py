"""Standalone Blender subprocess helpers for Plan-A local engines."""
...
def run_blender_python_script(
    *,
    ...
    """Run one standalone Blender Python script and capture logs."""
    ...
    with stdout_target.open("w", encoding="utf-8") as stdout_handle, stderr_target.open(
        "w", encoding="utf-8"
    ) as stderr_handle:
